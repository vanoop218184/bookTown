        ...
        <div className="w-full md:w-1/2 mt-12 md:mt-32 order-2 md:order-1 ">
          <div className="space-y-12">
            ...
            <p className="text-xl mt-8">
              “Every book in a bookstore is a fresh beginning. Every book is the
              next iteration of a very old story. Every bookstore, therefore, is
              like a safe-deposit box for civilization.” –
              <span className="font-bold text-amber-500">Liam Callanan</span>
            </p>
